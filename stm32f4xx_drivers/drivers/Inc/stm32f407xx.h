 ...
 * @{
 */
#define GPIOA_PCLK_DI()      ( RCC->AHB1ENR &= ~(unsigned int)(1<<0) )
#define GPIOB_PCLK_DI()      ( RCC->AHB1ENR &= ~(unsigned int)(1<<1) )
#define GPIOC_PCLK_DI()      ( RCC->AHB1ENR &= ~(unsigned int)(1<<2) )
#define GPIOD_PCLK_DI()      ( RCC->AHB1ENR &= ~(unsigned int)(1<<3) )
#define GPIOE_PCLK_DI()      ( RCC->AHB1ENR &= ~(unsigned int)(1<<4) )
#define GPIOF_PCLK_DI()      ( RCC->AHB1ENR &= ~(unsigned int)(1<<5) )
#define GPIOG_PCLK_DI()      ( RCC->AHB1ENR &= ~(unsigned int)(1<<6) )
#define GPIOH_PCLK_DI()      ( RCC->AHB1ENR &= ~(unsigned int)(1<<7) )
#define GPIOI_PCLK_DI()      ( RCC->AHB1ENR &= ~(unsigned int)(1<<8) )
 ...
 * @{
 */
#define I2C1_PCLK_DI()      ( RCC->APB1ENR &= ~(unsigned int)(1<<21) )
#define I2C2_PCLK_DI()      ( RCC->APB1ENR &= ~(unsigned int)(1<<22) )
#define I2C3_PCLK_DI()      ( RCC->APB1ENR &= ~(unsigned int)(1<<23) )
 ...
 * @{
 */
#define SPI1_PCLK_DI()      ( RCC->APB2ENR &= ~(unsigned int)(1<<12) )
#define SPI2_PCLK_DI()      ( RCC->APB1ENR &= ~(unsigned int)(1<<14) )
#define SPI3_PCLK_DI()      ( RCC->APB1ENR &= ~(unsigned int)(1<<15) )
 ...
 * @{
 */
#define USART2_PCLK_DI()      ( RCC->APB1ENR &= ~(unsigned int)(1<<17) )
#define USART3_PCLK_DI()      ( RCC->APB1ENR &= ~(unsigned int)(1<<18) )
#define USART1_PCLK_DI()      ( RCC->APB2ENR &= ~(unsigned int)(1<<4) )
#define USART6_PCLK_DI()      ( RCC->APB2ENR &= ~(unsigned int)(1<<5) )
