...
void I2C_CloseSendData(I2C_Handle_t *pI2CHandle)
{
    ...
    pI2CHandle->pI2Cx->CR2 &= ~(unsigned int) (1 << I2C_CR2_ITBUFEN ) ;
    // implement the code to disabe ITEVTEN Control Bit
    pI2CHandle->pI2Cx->CR2 &= ~(unsigned int) (1 << I2C_CR2_ITEVTEN ) ;
...
void I2C_ER_IRQHandling(I2C_Handle_t *pI2CHandle)
{
    ...
    if(temp1  && temp2 )
    {
        ...
        pI2CHandle->pI2Cx->SR1 &= ~(unsigned int)( 1 << I2C_SR1_BERR);
    ...
    if(temp1  && temp2)
    {
        ...
        pI2CHandle->pI2Cx->SR1 &= ~(unsigned int)( 1 << I2C_SR1_ARLO);
    ...
    if(temp1  && temp2)
    {
        ...
        pI2CHandle->pI2Cx->SR1 &= ~(unsigned int)( 1 << I2C_SR1_AF);
    ...
    if(temp1  && temp2)
    {
        ...
        pI2CHandle->pI2Cx->SR1 &= ~(unsigned int)( 1 << I2C_SR1_OVR);
    ...
    if(temp1  && temp2)
    {
        ...
        pI2CHandle->pI2Cx->SR1 &= ~(unsigned int)( 1 << I2C_SR1_TIMEOUT);
...
void I2C_PeripheralControl( I2C_RegDef_t *pI2Cx, uint8_t EnorDi )
{
    ...
    {
        pI2Cx->CR1 &= ~(unsigned int)(1 << I2C_CR1_PE ) ;
...
void I2C_ManageAcking( I2C_RegDef_t *pI2Cx, uint8_t EnorDi ) {
    ...
    if (EnorDi == I2C_ACK_ENABLE ) {
        ...
        pI2Cx->CR1 &= ~(unsigned int)(1 << I2C_CR1_ACK ) ;
    }
}
...
void I2C_SlaveEnableDisableCallbackEvents(I2C_RegDef_t *pI2Cx, uint8_t EnorDi)
{
    if (EnorDi == ENABLE) {
        ...
        pI2Cx->CR2 &= ~(unsigned int)(1 << I2C_CR2_ITBUFEN);
        pI2Cx->CR2 &= ~(unsigned int)(1 << I2C_CR2_ITERREN);
        pI2Cx->CR2 &= ~(unsigned int)(1 << I2C_CR2_ITEVTEN);
    }
}
